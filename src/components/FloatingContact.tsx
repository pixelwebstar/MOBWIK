...
const FloatingContact = () => {
  const [activeView, setActiveView] = useState<"none" | "menu" | "chat">("none");
  ...
  return (
    <div className="fixed bottom-8 right-6 sm:bottom-8 sm:right-8 z-[100] flex flex-col items-center w-14 h-auto">
      ...
      {/* Chat Interface */}
      {activeView === "chat" && (
        <div className="absolute bottom-16 right-0 sm:bottom-20">
          <ChatInterface onClose={() => setActiveView("none")} />
        </div>
      )}
